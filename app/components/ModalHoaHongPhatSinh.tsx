    ...
    <div className="fixed inset-0 bg-slate-900/40 backdrop-blur-sm flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-[2rem] w-full max-w-sm p-6 shadow-2xl animate-fade-in border border-white">
        ...
        <div className="bg-blue-50/50 border border-blue-100 rounded-2xl p-4 mb-5">
          ...
          <div className="font-black text-gray-900 text-base">{props.phatSinhDangChon.tenKhach || "Khách lẻ"}</div>
        ...
        <div className="grid gap-4">
          ...
          <div className="flex gap-3 mt-2">
            ...
            <button onClick={() => props.setShowHoaHongModal(false)} className="px-6 py-4 bg-gray-100 font-bold text-gray-600 rounded-2xl hover:bg-gray-200 active:scale-95 transition-all">Đóng</button>
          </div>
        </div>
      </div>
    </div>
